...
public final class Triangle extends ClosedCurve {
	...
	public Triangle(double s1, double s2, double s3)  {
		...
		/*
		 * An assertion is a statement in the Java programming language that enables you
		 * to test your assumptions about your program. For example, if you write a
		 * method that calculates the speed of a particle, you might assert that the
		 * side1 is less than or equals to side2 and side2 <= side3.
		 */
		assert(side1 <= side2 && side2 <= side3);
		assert(height <= base);
	}
